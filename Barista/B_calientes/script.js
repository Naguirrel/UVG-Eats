document.addEventListener("DOMContentLoaded", function () {
  ...
  const drinkData = {
    "Café Americano": { description: "Un café clásico.", price: 22 },
    "Capuccino": { description: "Con espuma de leche.", price: 23 },
    "Café Latte": { description: "Café con leche.", price: 22 },
    "Café Matcha": { description: "Un café clásico.", price: 22 },
    "Té Chai": { description: "Con espuma de leche.", price: 23 },
    "Té Negro": { description: "Café con leche.", price: 25 },
  };
